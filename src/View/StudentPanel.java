...
//    private UpdateUserInformation uinf = new UpdateUserInformation();

    public StudentPanel() {
        try {
            initComponents();
            this.setDefaultCloseOperation(DO_NOTHING_ON_CLOSE);
            lblUserName.setText(StudentLoginWindow.txtUserName.getText());
            try {
...
//          editorPane.setText(parseHyperText);
            ...
            try {
                if (ReadUserInformation.hasWritePermission(StudentLoginWindow.getTxtUserName().getText()).equalsIgnoreCase("True")) {
                    tAreaPageContent.setEditable(true);
                    btnPreview.setEnabled(true);
                    btnSavePageContent.setEnabled(true);
                } else if (ReadUserInformation.hasWritePermission(StudentLoginWindow.getTxtUserName().getText()).equalsIgnoreCase("False")) {
...
//        }
            ...
            if (ReadUserInformation.hasWritePermission(StudentLoginWindow.getTxtUserName().getText()).equalsIgnoreCase("false")) {
                btnRequestEditPermission.setEnabled(true);
            } else if (ReadUserInformation.hasWritePermission(StudentLoginWindow.getTxtUserName().getText()).equalsIgnoreCase("true")) {
                btnRequestEditPermission.setEnabled(false);
            }
        ...
        pnlBlogsOfAdmins.add(new AdminWikiPanel("Student", MiddleWare.uname));
        pnlBlogsOfAdmins.repaint();
        pnlBlogOfTutors.setLayout(new GridLayout());
        pnlBlogOfTutors.add(new TutorWikiPanel("Student", MiddleWare.uname));
        pnlBlogOfTutors.repaint();
        pnlBlogOfStudents.setLayout(new GridLayout());
        pnlBlogOfStudents.add(new StudentWikiPanel("Student", MiddleWare.uname));
    ...
    private void initComponents() {
        ...
        btnRequestEditPermission = new javax.swing.JButton();
        ...
        btnRequestEditPermission.setText("Request edit permission");
        btnRequestEditPermission.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRequestEditPermissionActionPerformed(evt);
            }
        });
        ...
        pnlEditPageLayout.setHorizontalGroup(
            pnlEditPageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
            .addGroup(pnlEditPageLayout.createSequentialGroup()
                .addGroup(pnlEditPageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlEditPageLayout.createSequentialGroup()
                        .addContainerGap(673, Short.MAX_VALUE)
                        .addComponent(btnRequestEditPermission)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
//            }
    ...
    private void btnRequestEditPermissionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestEditPermissionActionPerformed
        try {
            // TODO add your handling code here:

            MiddleWare.updateUserData.updatePermissionStatus(StudentLoginWindow.getTxtUserName().getText(), UpdateUserInformation.PERMISSION_STATUS, UpdateUserInformation.FALSE);
        } catch (SQLException ex) {
            Logger.getLogger(StudentPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnRequestEditPermissionActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnLogOut;
    private javax.swing.JButton btnPreview;
    private javax.swing.JButton btnRequestEditPermission;

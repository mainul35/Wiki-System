...
public class AdminLoginWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAdminSignUp.setText("Register as Admin");
    ...
    private void btnAdminLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminLoginActionPerformed
        try {
            // TODO add your handling hiode here:
            if(MiddleWare.readUserData.checkLogInData(txtUserName.getText(), txtPassword.getText())==true){
                CreateUserInformation.createDirectory("Admin\\"+txtUserName.getText());
                AdminPanel up = new AdminPanel();
                up.setVisible(true);
                this.dispose();
                AdminPanel.lblUserName.setText(this.txtUserName.getText());
            }
    ...
    private void btnAdminSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminSignUpActionPerformed
        ...
        AdminSignupWindow asw = new AdminSignupWindow();
        asw.setVisible(true);
        this.dispose();
